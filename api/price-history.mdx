---
title: "Price History API — Coffee Buyer Price Change Logs"
sidebarTitle: "Price History"
description: "GET /api/historial-precios returns a time-series log of all buyer price changes. Requires authentication. Supports filtering by buyer ID and coffee type."
---
