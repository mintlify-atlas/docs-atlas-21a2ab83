---
title: "Auto-Aggregated Coffee News Feed"
sidebarTitle: "News"
description: "CoffePrice automatically fetches and summarizes coffee-sector news from NewsAPI, GNews, TheNewsAPI, and NewsData. Admins can trigger manual generation via the API."
---
