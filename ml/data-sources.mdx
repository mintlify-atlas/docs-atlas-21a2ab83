...
<Tip>
The final feature set passed to XGBoost (`feature_columns()`) contains **45 columns** including `prophet_yhat` as an additional input, allowing XGBoost to learn corrections on top of Prophet's forecast rather than starting from scratch.
</Tip>
