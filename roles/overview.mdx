...
description: "CoffePrice has three user roles — productor, comprador, and admin — each with its own dashboard, account states, and set of permitted API endpoints."
---
